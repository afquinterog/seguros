									...
									<table class="table table-striped table-bordered table-hover" id="table" style="margin-bottom:5px">
										<thead>
											<tr>
												...
												<th class="hidden-480">Fecha venc</th>
										...
										<tbody>
											<?php
												if(isset($this->data)){
													foreach($this->data as $item){
														$ramoDesc = isset($item->ramo->descripcion) ? $item->ramo->descripcion : "" ;
														$clienteDesc = $item->tomador->primer_nombre   ." ". $item->tomador->segundo_nombre . " " .
														               $item->tomador->primer_apellido ." ". $item->tomador->segundo_apellido ;
											...
											?>
												<tr class="odd gradeX">
													...
													<td class="hidden-480"><?php echo $clienteDesc;?></td>
													<td class="hidden-480"><?php echo $ramoDesc ;?></td>
													<td class="hidden-480"><?php echo $item->fecha_fin; ?></td>
