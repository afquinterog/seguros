						...
						<?php PortletHelper::show("Listado de Tareas"); ?>		
								...
								<form id='formTable' >
									<table class="table table-striped table-bordered table-hover" id="table" style="margin-bottom:5px">
										<thead>
											<tr>
												<th><input type="checkbox" class="" style="opacity: 0;" onclick="toggle(this, 'id[]')"></th>
										...
										<tbody>
											...
											?>
												<tr class="odd gradeX">
													<td ><input type="checkbox" name='id[]' value="<?php echo $item->id; ?>" class="mail-checkbox" style="opacity: 0;"/></td>
													<td><?php echo $item->descripcion;?></td>
													<td class="hidden-480"><?php echo $item->fecha_creacion;?></td>
													<td><?php echo $item->fecha_entrega;?></td>
													<td><?php echo $item->usuario_asignado;?></td>
													<td><?php echo ($item->activo == 1 ? "P" : "T");?></td>
													<td><?php echo $linkHistorial;?></td>
